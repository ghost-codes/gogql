...
func (l *UserLoader) Load(key int64) (*db.User, error) {
...
func (l *UserLoader) LoadThunk(key int64) func() (*db.User, error) {
	l.mu.Lock()
...
func (l *UserLoader) LoadAll(keys []int64) ([]*db.User, []error) {
...
// This method should be used if you want one goroutine to make requests to many
// different data loaders without blocking until the thunk is called.
func (l *UserLoader) LoadAllThunk(keys []int64) func() ([]*db.User, []error) {
	results := make([]func() (*db.User, error), len(keys))
	for i, key := range keys {
		results[i] = l.LoadThunk(key)
	}
...
func (l *UserLoader) Prime(key int64, value *db.User) bool {
	l.mu.Lock()
	var found bool
...
func (l *UserLoader) unsafeSet(key int64, value *db.User) {
	if l.cache == nil {
		l.cache = map[int64]*db.User{}
	}
	l.cache[key] = value
}
