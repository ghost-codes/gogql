...
func (ec *executionContext) field_Mutation_createVideo_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["input"]; ok {
		...
		arg0, err = ec.unmarshalONewVideo2ᚖgithubᚗcomᚋghostᚑcodesᚋgogqlᚋgraphᚋmodelᚐNewVideo(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) unmarshalInputNewVideo(ctx context.Context, obj interface{}) (model.NewVideo, error) {
	...
	fieldsInOrder := [...]string{"title", "url", "user_id"}
...
func (ec *executionContext) unmarshalONewVideo2ᚖgithubᚗcomᚋghostᚑcodesᚋgogqlᚋgraphᚋmodelᚐNewVideo(ctx context.Context, v interface{}) (*model.NewVideo, error) {
	if v == nil {
		return nil, nil
	}
